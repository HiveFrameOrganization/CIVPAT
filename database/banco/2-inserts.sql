...
(1, 0000000, 'Nenhum'),
(2, 1107345, 'CENTRO USINAGEM 5 EIXOS P MICROUSINAGEM/ MIKRON'),
(3, 1237768, 'DIGITALIZADOR HANDYSCAN 3D'),
(4, 1036511, 'ELETROEROSÃO P/CORTE FIO 0,05MM CNC/ GF'),
(5, 1240310, 'EQUIPAMENTO DE FUSÃO SELETIVA A LASER'),
(6, 1262915, 'IMPRESSORA 3D FDM - Ultimaker 01'),
(7, 1262916, 'IMPRESSORA 3D FDM - Ultimaker 02'),
(8, 1262913, 'IMPRESSORA 3D SLA - Form 3L'),
(9, 1262914, 'IMPRESSORA 3D SLS'),
(10, 1265308, 'MÁQUINA CNC P/CORTE GRAVAÇÃO A LASER'),
(11, 1049606, 'MÁQUINA DE PROTOTIPAGEM RÁPIDA/CONNEX350'),
(12, 1240778, 'MÁQUINA DE TEXTURIZAÇÃO A LASER'),
(13, 1265273, 'MÁQUINA ELETROEROSÃO POR PENETRAÇÃO CNC'),
(14, 1237270, 'MÁQUINA PROTOTIPADORA 3D FLS - Form3'),
(15, 730454, 'APARELHO MEDIDOR DE CIRCULARIDADE'),
(16, 730453, 'APARELHO P/MEDICAO PERFIS E RUGOSIDADE'),
(17, 1267167, 'BRAÇO DE MEDIÇÃO 3D'),
(18, 703124, 'CALIBRADOR MULTIFUNCAO ATE 6-5 DIGITOS'),
(19, 624820, 'CANETA MEDIDORA VIBRACAO CMVP50 SKF'),
(20, 720363, 'CONJUNTO CALIBRACAO DE MICROMETROS'),
(21, 720364, 'CONJUNTO CALIBRACAO DE PAQUIMETROS'),
(22, 1240534, 'CORTADORA METALOGRÁFICA DE PRECISÃO'),
(23, 1271208, 'DURÔMETRO DIGITAL - ROCKWELL BRINELL'),
(24, 697036, 'FORNO BLOCO SECO 120GC T25N-2-BP-06'),
(25, 1107344, 'INTERFERÔMETRO P/ MED.SUPERFÍCIE 3D /TAYLOR'),
(26, 730455, 'MAQUINA DE CALIBRACAO AUTOMATICA'),
(27, 1075886, 'MÁQUINA MEDIÇÃO 3D POR TOMOGRAFIA/CARL ZEISS'),
(28, 1237839, 'MEDIDOR DE ÂNGULO DE CONTATO'),
(29, 1240344, 'MICRODURÔMETRO AUTOMÁTICO'),
(30, 1087543, 'MICROSCÓPIO DE FORÇA ATÔMICA / NANOSURF'),
(31, 1044106, 'MICROSCÓPIO ELETRÔN.DE VARREDURA/HITACHI 01'),
(32, 1044108, 'MICROSCÓPIO ELETRÔN.DE VARREDURA/HITACHI 02'),
(33, 758276, 'MICROSCOPIO ESTEREOSCOPIO ZOOM OLYMPUS'),
(34, 1239069, 'POLITRIZ/LIXADEIRA AUTOMÁTICA');
...
('1239567', 'Mayck', 'jackson', NULL, 'ger', 'gerente@sp.senai.br', '$2y$10$E7UMnumHaqDt6wHBMwCVE.Bv7kGU0XaugH7zQS3ivUAISk8/tlmay', 'ativo'),
...
('1234667', 'Gustavo', 'jackson', NULL, 'ger', 'gerencio@sp.senai.br', '$2y$10$E7UMnumHaqDt6wHBMwCVE.Bv7kGU0XaugH7zQS3ivUAISk8/tlmay', 'ativo'),
...
'Jacksons 5', 'Concluido', NULL, '75090673000189', NULL, NULL, NULL),
(default, 1, '1234567', 'Jacaré a Jato', 'Text', 9, 
'Jacksons 5', 'Concluido', NULL, '75090673000189', NULL, NULL, NULL),
(default, 1, '1234567', 'Jacaré a Jato', 'Text', 9, 
'Jacksons 5', 'Concluido', NULL, '75090673000189', NULL, NULL, NULL),
...
'Jacksons 5', 'Concluido', NULL, '75090673000189', NULL, NULL, NULL),
(default, 1, '1234567', 'Jacaré a Jato', 'Text', 9, 
'Jacksons 5', 'Aceito', NULL, '75090673000189', NULL, NULL, NULL),
(default, 1, '1234567', 'Jacaré a Jato', 'Text', 9, 
'Jacksons 5', 'Aceito', NULL, '75090673000189', NULL, NULL, NULL),
(default, 1, '1234567', 'Jacaré a Jato', 'Text', 9, 
'Jacksons 5', 'Aceito', NULL, '75090673000189', NULL, NULL, NULL),
...
'Jacksons 5', 'Em Análise', NULL, '75090673000189', NULL, NULL, NULL),
(default, 1, '1234567', 'Jacaré a Jato', 'Text', 9, 
'Jacksons 5', 'Declinado', NULL, '75090673000189', NULL, NULL, NULL),
(default, 1, '1234567', 'Jacaré a Jato', 'Text', 9, 
'Jacksons 5', 'Declinado', NULL, '75090673000189', NULL, NULL, NULL),
(default, 1, '1234567', 'Jacaré a Jato', 'Text', 9, 
'Jacksons 5', 'Declinado', NULL, '75090673000189', NULL, NULL, NULL),
...
(default, 1, 1, 1, '2023-09-01', '2023-09-01'),
(default, 1, 1, 2, '2023-09-01', '2023-09-01'),
(default, 1, 1, 3, '2023-09-01', '2023-09-01'),
(default, 1, 1, 4, '2023-09-01', '2023-09-01'),
(default, 1, 1, 5, '2023-09-01', '2023-09-01'),
(default, 1, 1, 6, '2023-09-01', '2023-09-01'),
(default, 1, 1, 7, '2023-09-01', '2023-09-01'),
(default, 1, 1, 8, '2023-09-01', '2023-09-01'),
(default, 1, 1, 9, '2023-09-01', '2023-09-01'),
(default, 1, 1, 10, '2023-09-01', '2023-09-01'),
(default, 1, 1, 11, '2023-09-01', '2023-09-01'),
(default, 1, 1, 12, '2023-09-01', '2023-09-01'),
(default, 1, 1, 13, '2023-09-01', '2023-09-01'),
(default, 1, 1, 14, '2023-09-01', '2023-09-01'),
(default, 1, 1, 15, '2023-09-01', '2023-09-01'),
(default, 1, 1, 16, '2023-09-01', '2023-09-01'),
(default, 1, 1, 17, '2023-09-01', '2023-09-01'),
(default, 1, 1, 18, '2023-09-01', '2023-09-01'),
(default, 1, 1, 19, '2023-09-01', '2023-09-01'),
(default, 1, 1, 20, '2023-09-01', '2023-09-01'),
(default, 1, 1, 21, '2023-09-01', '2023-09-01'),
(default, 1, 1, 22, '2023-09-01', '2023-09-01'),
(default, 1, 1, 23, '2023-09-01', '2023-09-01'),
(default, 1, 1, 24, '2023-09-01', '2023-09-01'),
(default, 1, 1, 25, '2023-09-01', '2023-09-01'),
(default, 1, 1, 26, '2023-09-01', '2023-09-01'),
(default, 1, 1, 27, '2023-09-01', '2023-09-01'),
(default, 1, 1, 28, '2023-09-01', '2023-09-01'),
(default, 1, 1, 29, '2023-09-01', '2023-09-01'),
(default, 1, 1, 30, '2023-09-01', '2023-09-01'),
(default, 1, 1, 31, '2023-09-01', '2023-09-01');

INSERT INTO Produtos VALUES
(1, 1, '1234560', 1, 1, 1, 1, 'metalmecanica', 123, 123, 123, '2023-09-12', '2023-09-23', "Em andamento"),
(2, 1, '1234560', 1, 1, 1, 1, 'metalmecanica', 123, 123, 123, '2023-09-12', '2023-09-23', "Em andamento"),
(3, 1, '1234560', 1, 1, 1, 1, 'metalmecanica', 123, 123, 123, '2023-09-12', '2023-09-23', "Em andamento");

    ...
    if (!response.ok) {
        ...
        div.innerHTML = `
            <div class='w-full flex flex-col justify-center items-center gap-4'>
                ...
                <h2 class='font-bold'>ERRO NA REQUISIÇÃO</h2>
                <p>Um erro aconteceu, mas não foi sua culpa, tente recarregar a página!</p>
            </div>
        `;
    }
...
.then(data => {
    ...
    if (data && data.length > 0) {
        ...
        <div class='w-full flex flex-col justify-center items-center gap-4'>
            ...
            <h2 class='font-bold text-color-text'>NENHUM FOLLOW-UP ENCONTRADO</h2>
        </div>
        `;
    }

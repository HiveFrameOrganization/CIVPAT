        ...
        for (let i = 0; i < res.dados.length; i++) {
            ...
            if (nif == null) {
                ...
                cabeçalho.innerHTML = `
                    ...
                    <p class='text-color-text whitespace-nowrap font-semibold text-lg leading-4 capitalize'>${Number(res.dados[i].HorasPessoa) + Number(res.dados[i].HorasMaquina)} Horas</p>
